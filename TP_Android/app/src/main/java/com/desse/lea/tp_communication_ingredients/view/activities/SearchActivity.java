...
import com.desse.lea.tp_communication_ingredients.BasketActivity;
...
public class SearchActivity extends AppCompatActivity {
    ...
    //private businessManagerInterface mGetData = new getDataMock(this);
    ...
    private void findViewsByIds() {
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //    Toast.makeText(SearchActivity.this, "Please input some texts", Toast.LENGTH_SHORT).show();
                //} else {
                    //TODO: here

                mDb = AppDatabase.getInMemoryDatabase(getApplicationContext());

                List<Ingredient> ingres = mDb.ingredientModel().loadAllIngredients();

                String[] list = new String[ingres.size()];


                for (int i = 0; i <= ingres.size()-1; i++) {
                    Ingredient ingre = ingres.get(i);
                    list[i] = ingre.getMName();
                    sendMessage(list[i]);
